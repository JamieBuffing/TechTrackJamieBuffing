...
import { r as resolveSteamId, g as getSchemaForGame, a as getPlayerAchievements } from "../../../../chunks/steamApi.js";
async function GET({ url, fetch }) {
  try {
    ...
    const percentage = total ? Number((unlocked / total * 100).toFixed(1)) : 0;
    return json({
      steamid,
      appid,
      total,
